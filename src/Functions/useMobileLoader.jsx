...
const MobileLoader = (props) => (
 <ContentLoader viewBox="0 0 900 280" height={150} width={350} backgroundColor="#76abae22" foregroundColor="#555" {...props}>
    {/* Image on the left */}
    ...
    <rect x="280" y="98" rx="0" ry="0" width="115" height="9" />
    <rect x="280" y="115" rx="0" ry="0" width="115" height="10" />
  </ContentLoader>
);
